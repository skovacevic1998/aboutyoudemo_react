    ...
    <>
      <div>
        ...
        <Typography className="typography-custom">
          ...
          nudi ti sve što trebaš za svoj sljedeći outfit: od A do Ž. Baci se na
          traženje aktualnih trendova i inspiriraj se klasičnim krojevima i
          modelima. Naručene proizvode dostavit ćemo ti brzo i povoljno na tvoju
          kućnu adresu. Ukoliko neki od proizvoda ne odgovara tvom ukusu, možeš
        ...
        <Typography className="typography-custom">
          ...
          i boja. Šareni modeli bude želju za ljetom. Suptilnim topovima istakni
          figuru na jesen i zimu. Kako se ne bi smrzavala u hladnom dijelu
          godine, naruči kod nas odgovarajuću jaknu. Inovativne značajke kao što
          je uklonjiva unutarnja podstava, debela kapuljača ili strukirani kroj
        ...
        <Typography className="typography-custom">
          ...
          koji uključuje i boyfriend traperice kao i klasične platnene hlače.
          Sve modne marke nude ti mogućnost da pomoću kalkulatora veličine
          odabereš svoju individualnu veličinu hlača. Jednostavno unesi veličinu
          svojih dosadašnjih hlača te sa jednim klikom otkrij specifičnu
        ...
        <Typography className="typography-custom">
          ...
          ljeto, jesen i zimu pronaći ćeš na ABOUT YOU. Šareni dizajn budi želju
        ...
        <Typography className="typography-custom">
          ...
          imaš pitanja o svojoj narudžbi, iskoristi mogućnosti i obrati se ABOUT
          YOU službi za korisnike.
        </Typography>
      </div>
    </>
  );
